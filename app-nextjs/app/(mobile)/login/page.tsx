  ...
  return (
    <div className="h-full flex flex-col" style={{ backgroundColor: "#FFFFFF" }}>
      <div className="p-4 flex items-center">
        <button onClick={() => router.push("/")} className="p-2 rounded-full" aria-label="Go back">
          <ArrowLeft className="w-6 h-6" style={{ color: "#888888" }} />
        </button>
      </div>

      <div className="flex-1 flex flex-col justify-center px-6 pb-24">
        <h1 style={{ fontFamily: "var(--font-outfit)", fontSize: "32px", fontWeight: 700, color: "#0A0A0A", marginBottom: "8px" }}>
          Welcome back
        </h1>
        <p style={{ fontFamily: "var(--font-outfit)", fontSize: "14px", color: "#888888", marginBottom: "32px" }}>
        ...
        <div className="space-y-5">
          <div>
            ...
            <input
              ...
              style={{
                fontFamily: "var(--font-outfit)", fontSize: "16px", padding: "14px 18px",
      ...
      <div className="absolute bottom-0 left-0 right-0 px-6 py-6" style={{ backgroundColor: "#FFFFFF" }}>
        ...
        <p className="mt-4 text-center" style={{ fontFamily: "var(--font-outfit)", fontSize: "14px", color: "#888888" }}>
          Don&apos;t have an account?{" "}
          <button onClick={() => router.push("/register")} style={{ color: "#14B8BB", fontWeight: 600 }}>
            Sign up
          </button>
        </p>
      </div>
